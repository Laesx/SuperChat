...
public class ServidorAntiguo {
    ...
    public ServidorAntiguo(int puerto) throws IOException {
        serverSocket = new ServerSocket(puerto);
    }

    // igual que en el ejemplo anterior
    public SocketAddress start () throws IOException {
        //System.out.println(" (ServidorAntiguo) Esperando conexiones...");
        socket=serverSocket.accept();
        is = socket.getInputStream();
        os = socket.getOutputStream();
        System.out.println(LocalDateTime.now().format(DateTimeFormatter.ofPattern("(HH:mm:ss)")) +
                " (ServidorAntiguo) Conexión establecida con cliente "+socket.getRemoteSocketAddress());
    ...
    public String leerMensajeTexto()  throws IOException {
        //System.out.println(" (ServidorAntiguo) Leyendo mensaje...");
        String mensaje = br.readLine();
        //System.out.println(" (ServidorAntiguo) Mensaje leido.");
        return mensaje;
    }

    public void enviarMensajeTexto(String mensaje) {
        //System.out.println(" (ServidorAntiguo) Enviando mensaje...");
        pw.println(mensaje);
        //System.out.println(" (ServidorAntiguo) Mensaje enviado.");
    }
    ...
    public static void main (String[] args) {
        ...
        try {
            //Iniciamos
            ServidorAntiguo servidor = new ServidorAntiguo(49175);
